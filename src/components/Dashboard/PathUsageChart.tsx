    ...
    return (
        <ResponsiveContainer width="100%" height={400}>
            <LineChart data={metrics} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                ...
                <Legend />
                <Line type="monotone" dataKey="usage_count" stroke="var(--color-lab-turquoise)" activeDot={{ r: 5, stroke: "var(--color-lab-turquoise)" }} />
                <Line type="monotone" dataKey="finished_count" stroke="var(--color-lab-green-dark)" activeDot={{ r: 5, stroke: "var(--color-lab-green-dark)" }} />
            </LineChart>
        </ResponsiveContainer>
    );
};
