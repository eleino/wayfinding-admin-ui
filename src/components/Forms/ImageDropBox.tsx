...
export const ImageDropBox = ({ onFileSelect, imageUrl }: ImageDropBoxProps) => {
    ...
    return (
        ...
        onDrop={handleDrop}
        className={`border border-dashed border-lab-turquoise rounded h-40 w-80 flex items-center justify-center cursor-pointer bg-black ${preview ? 'p-1' : ''}`}
        > 
        {preview ? (
            <span className="flex flex-row justify-center items-center gap-2">
                <img src={preview} alt="Preview" className="h-40 p-2" />
